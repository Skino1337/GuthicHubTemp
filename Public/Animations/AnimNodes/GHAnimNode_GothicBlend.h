...
#include "GHAnimNode_GothicBlend.generated.h"



USTRUCT(BlueprintInternalUseOnly)
struct GOTHICHUB_API FAnimNode_GothicBlend : public FAnimNode_Base
{
	GENERATED_BODY()
...
public:
	...
	TArray<FPoseLink> BlendPoses = {FPoseLink()};
	...
	// TArray<FInputBlendPose> LayerSetup = {FInputBlendPose()};
	...
	TArray<float> BlendWeights = {1.0f};
...
protected:
	...
	TArray<FString> CurrentBoneNameArray;
	
public:	
	FAnimNode_GothicBlend()
...
private:
	...
	void RebuildPerBoneBlendWeights(const USkeleton* InSkeleton, const UObject* AnimInstanceObject);
	...
	void UpdateCachedBoneData(const FBoneContainer& RequiredBones, const USkeleton* Skeleton, const UObject* AnimInstanceObject);
